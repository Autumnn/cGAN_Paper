...
#   LN: means later nomination, first "StratifiedKFold" ant then "min_max_scalar".
...
with open(file_wirte,'a') as w:
    AUC_line = name + '\t' + "SMOTE-SVM-LN" + '\t' + "AUC" + '\t'
    ...
    G_line = name + '\t' + "SMOTE-SVM-LN" + '\t' + "F_Mean" + '\t'
    ...
    F_line = name + '\t' + "SMOTE-SVM-LN" + '\t' + "G_Mean" + '\t'
